...
std::wstring removeFromEnd_copy(const std::wstring source, const std::wstring sequence, const bool ignoreCase = true,
	const bool repetative = true);
std::string removeFromBothSides_copy(const std::string source, const std::string sequence,
	const bool ignoreCase = true, const bool repetative = true);
std::wstring removeFromBothSides_copy(const std::wstring source, const std::wstring sequence,
	const bool ignoreCase = true, const bool repetative = true);
...
std::wstring reverseJoinStrs(const std::vector<std::wstring> strs, const std::wstring delimiter = L"",
	const size_t startIdx = 0, const size_t endIdx = 0);
void removeSubstr(std::string &source, const std::string sequence, const bool ignoreCase = true);
void removeSubstr(std::wstring &source, const std::wstring sequence, const bool ignoreCase = true);
void removeSubstr(std::string &source, const std::vector<std::string> sequences, const bool ignoreCase = true);
void removeSubstr(std::wstring &source, const std::vector<std::wstring> sequences, const bool ignoreCase);
std::string removeSubstr_copy(const std::string source, const std::string sequence, const bool ignoreCase = true);
std::wstring removeSubstr_copy(const std::wstring source, const std::wstring sequence, const bool ignoreCase = true);
std::string removeSubstr_copy(const std::string source, const std::vector <std::string> sequences,
	const bool ignoreCase = true);
std::wstring removeSubstr_copy(const std::wstring str, const std::vector <std::wstring> sequences,
	const bool ignoreCase = true);
void replaceAll(std::string &source, const std::string replaceWhat,
	const std::string replaceWith, const bool ignoreCase = true);
void replaceAll(std::wstring &source, const std::wstring replaceWhat,
	const std::wstring replaceWith, const bool ignoreCase = true);
std::string replaceAll_copy(const std::string source, const std::string replaceWhat, const  std::string replaceWith,
	const bool ignoreCase = true);
